   ------------------------------------------HAshCode----------------------------------------------------------
    ...
    Tabela Hash organiza os nomes de uma forma otimizada para que voce tenha um otimo
    desempenho na insercao e nas buscas, com o exemplo abaixo temos o valor 42, entao o java cria um conjunto
    ...
    Agora imagine que temos o nome DIRK = 4 + 9 + 18 + 11 = 42, para o java saber qual o jeito queremos
    ...
    o mesmo atributo que usamos para comparacao do equals, isso porque se x.equasl(y) ==true
